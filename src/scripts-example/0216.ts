...
export const script0216: EpisodeScript = {
  season: 2,
  episode: 16,
  slugSeason: "s02",
  slugEpisode: "e16",
  ...
  lines: [
    {
      id: "l1",
      speaker: null,
      text: "[Scene: Chandler and Joey's apartment. Chandler and Joey are sitting at the bar, in their bathrobes, eating cereal]",
    },
    {
      id: "l2",
      speaker: null,
      text: "JOEY: Man this is weird. You ever realize Captain Crunch's eyebrows are actually on his hat? CHANDLER: That's what's weird? Joey, the man's been captain of a cereal for the last 40 years. [Joey finishes his cereal, licks his spoon, and puts it back in the silverware drawer.] CHANDLER: Waaa-aaah. JOEY: What? CHANDLER: The spoon. You licked and-and you put. You licked and you put. JOEY: Yeah, so. CHANDLER: Well don't you see how gross that is? I mean that's like you using my toothbrush. [Joey gets a sheepish look] You used my toothbrush? JOEY: Well, that was only 'cause I used the red one to unclog the drain. CHANDLER: Mine is the red one! Oh God. Can open, worms everywhere. JOEY: Hey, why can't we use the same toothbrush, but we can use the same soap? CHANDLER: Because soap is soap. It's self-cleaning. JOEY: Alright, well next time you take a shower, think about the last thing I wash and the first thing you wash. OPENING TITLES",
    },
    {
      id: "l3",
      speaker: null,
      text: "[Scene: Monica and Rachel's apartment. Monica and Phoebe are sitting at the table, Joey and Chandler enter.]",
    },
    {
      id: "l4",
      speaker: null,
